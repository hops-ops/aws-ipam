...
* feat(deps): update crossplane-contrib/function-auto-ready docker tag to v0.6.4 (#41) (by @renovate[bot])

  Co-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>


See full diff: [v0.23.0...v0.24.0](https://github.com/hops-ops/aws-ipam/compare/v0.23.0...v0.24.0)
